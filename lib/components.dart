...
class AnimatedCardPro extends StatefulWidget {
  final imagePath;
  final text;
  final fit;
  final reverse;
  const AnimatedCardPro(
      {Key? key,
      @required this.imagePath,
      @required this.text,
      this.fit,
  ...
  @override
  State<AnimatedCardPro> createState() => _AnimatedCardProState();
}

class _AnimatedCardProState extends State<AnimatedCardPro>
    with SingleTickerProviderStateMixin {
  late AnimationController _controller = AnimationController(
    vsync: this,
    duration: const Duration(seconds: 4),
